...
const IsAuthNav = () => {
  ...
  return (
    <React.Fragment>
          <nav className='h-[40px] md:h-[56px] flex justify-between px-10 lg:px-0 lg:justify-around items-center'>
          ...
          <div className='hidden md:block relative text-3xl px-3 py-2'>
          ...
          <div className='hidden md:block text-xs lg:text-sm'>
              <Link to='/createProduct'>
                 <button className='bg-primary w-16 lg:w-20 py-2 mx-2 rounded-sm text-white'>Add Item</button>
              </Link>
          </div>
        </nav>
    </React.Fragment>
